jQuery(function($){
	...
	var ttMobileProductSlider = $('.tt-mobile-product-slider')
	var ttModalQuickView = $('#ModalquickView')
	var $document = $(document),
		...
		if (ttMobileProductSlider.length) {
			ttMobileProductSlider.slick({
				dots: true,
				arrows: false,
				infinite: true,
				speed: 300,
			...
			if($html.hasClass('ie')){
				ttModalQuickView.each(function() {
					ttMobileProductSlider.slick("slickSetOption", "infinite", false);
				});
			};
		};
